...
// The browser audio backend: a thin adapter over the host's WebAudio graph.
// Sources are per-voice host nodes; the host mixes and resamples. It is the
// same shape as the null/openal backends (wasi/audio/DESIGN.md).
